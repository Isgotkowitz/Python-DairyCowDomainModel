...
RAW_COW_SCHEMA = StructType([
    ...
    StructField("KPIs", ArrayType(StructType([
    ...
    StructField("Lactations", StructType([
        StructField("KPIs", ArrayType(StringType(), True), True),
        StructField("complexLactations", ArrayType(StructType([
            StructField("KPIs", ArrayType(StringType(), True), True),
            StructField("lactationDays", ArrayType(StructType([
                StructField("DailyEvents", ArrayType(StructType([
